...
\begin{enumerate}[label=(\alph*)]
  ...
  \item I stored the likelihood for every iteration just to compare, which can be found in the likelihoods list in my $grad\_ascent.py$ file. With that said, the final value for the log-likelihood of $\hat{\theta}$ is: -0.6700727101571831
